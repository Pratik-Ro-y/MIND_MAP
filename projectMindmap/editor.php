...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .export-options { display: none; position: absolute; background-color: #f9f9f9; min-width: 160px; box-shadow: 0px 8px 16px 0px rgba(0,0,0,0.2); z-index: 1; }
...
<body>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            setupEventListeners();
            setInterval(saveMindMap, 30000); // Auto-save every 30 seconds
        });
        ...
        function drawConnection(p, c) {
            ...
            const pX = p.x + pEl.offsetWidth / 2;
            const pY = p.y + pEl.offsetHeight / 2;
            const cX = c.x + cEl.offsetWidth / 2;
